 ...
 * html template
 *********************************************************************************/
var MemberLoginComplete = React.createClass({
    componentDidMount:function() {
        var _this=this,
            _userIdx=_this.props.userIdx;
        console.log(_this.props.userIdx);
        //높이 설정 공통 부분
    ...
    render : function () {
        var _contents = null,
            _contents = <MemberLoginComplete />;

        return (
            <div className={"page "+loc[4].pageName+" "+this.props.position}>
